...
class Descomp:
    ...
    def Descomposicion(self):
        self.N = int(input('Ingrese el valor del orden de 1 a 2 : '))
        ...
        if self.N ==1:
            ...
            Dz = 2
            IL = image_convolved1[::Dz, ::Dz]
            IH = image_convolved2[::Dz, ::Dz]
            IV = image_convolved3[::Dz, ::Dz]
            ID = image_convolved4[::Dz, ::Dz]
        ...
        # Descomposición de Orden 2
            ...
            # Diezmado
            ILL = image_convolved5[::Dz, ::Dz]
            IHL = image_convolved6[::Dz, ::Dz]
            IVL = image_convolved7[::Dz, ::Dz]
            IDL = image_convolved8[::Dz, ::Dz]
